...
public class IndexModel : PageModel
{
    ...
    public IEnumerable<Currency> Valutes { get; set; } = Enumerable.Empty<Currency>();
    ...
    public IndexModel(CurrencyDbContext context, HttpClient client) {
        _context = context;
        _client = client;
    }
    public void OnGet() {
        Valutes =  _context.Currencies.ToList();
    ...
    public void GetCoursesByValute() {
